...
{
    this->Timestamp2 = other.Timestamp2;
    this->color = other.color;
    this->been_in_service = other.been_in_service;
}

void MyMessage::parsimPack(omnetpp::cCommBuffer *b) const
{
    ::omnetpp::cMessage::parsimPack(b);
    doParsimPacking(b,this->Timestamp2);
    doParsimPacking(b,this->color);
    doParsimPacking(b,this->been_in_service);
}

void MyMessage::parsimUnpack(omnetpp::cCommBuffer *b)
{
    ::omnetpp::cMessage::parsimUnpack(b);
    doParsimUnpacking(b,this->Timestamp2);
    doParsimUnpacking(b,this->color);
    doParsimUnpacking(b,this->been_in_service);
}

::omnetpp::simtime_t MyMessage::getTimestamp2() const
{
    return this->Timestamp2;
}

void MyMessage::setTimestamp2(::omnetpp::simtime_t Timestamp2)
{
    this->Timestamp2 = Timestamp2;
}

int MyMessage::getColor() const
{
    return this->color;
}

void MyMessage::setColor(int color)
{
    this->color = color;
}

int MyMessage::getBeen_in_service() const
{
    return this->been_in_service;
}

void MyMessage::setBeen_in_service(int been_in_service)
{
    this->been_in_service = been_in_service;
}
...
int MyMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='T' && strcmp(fieldName, "Timestamp2")==0) return base+0;
    if (fieldName[0]=='c' && strcmp(fieldName, "color")==0) return base+1;
    if (fieldName[0]=='b' && strcmp(fieldName, "been_in_service")==0) return base+2;
...
std::string MyMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    ...
    MyMessage *pp = (MyMessage *)object; (void)pp;
    switch (field) {
        case 0: return simtime2string(pp->getTimestamp2());
        case 1: return long2string(pp->getColor());
        case 2: return long2string(pp->getBeen_in_service());
        default: return "";
    }
}
...
bool MyMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    ...
    MyMessage *pp = (MyMessage *)object; (void)pp;
    switch (field) {
        case 0: pp->setTimestamp2(string2simtime(value)); return true;
        case 1: pp->setColor(string2long(value)); return true;
        case 2: pp->setBeen_in_service(string2long(value)); return true;
